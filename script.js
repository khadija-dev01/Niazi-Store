...
const productData = [
  ...
  },
  {
    ...
    description: { fa: "انگور شیرین و بی هسته", en: "Sweet seedless grapes" },
    price: 120,
    image: "🍇",
    unit: { fa: "کیلوگرم", en: "kg" },
  },
  ...
  },
  {
    ...
    description: { fa: "عدس قرمز درجه یک", en: "Premium red lentils" },
    price: 100,
    image: "🫘",
    unit: { fa: "کیلوگرم", en: "kg" },
  },
  ...
  // Snacks
  {
    ...
    description: { fa: "چیپس سیب زمینی ترد", en: "Crispy potato chips" },
    price: 30,
    image: "🍟",
    unit: { fa: "بسته", en: "pack" },
  },
